...
type CalculatorServiceClient interface {
	...
	PrimeFactors(ctx context.Context, in *PrimeRequest, opts ...grpc.CallOption) (CalculatorService_PrimeFactorsClient, error)
...
func (c *calculatorServiceClient) Sum(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error) {
	out := new(SumResponse)
	err := c.cc.Invoke(ctx, "/numbers.CalculatorService/Sum", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *calculatorServiceClient) PrimeFactors(ctx context.Context, in *PrimeRequest, opts ...grpc.CallOption) (CalculatorService_PrimeFactorsClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[0], "/numbers.CalculatorService/PrimeFactors", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *calculatorServicePrimeFactorsClient) Recv() (*PrimeResponse, error) {
	m := new(PrimeResponse)
...
func (c *calculatorServiceClient) Avg(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_AvgClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[1], "/numbers.CalculatorService/Avg", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *calculatorServiceClient) Max(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_MaxClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[2], "/numbers.CalculatorService/Max", opts...)
	if err != nil {
		return nil, err
	}
...
type CalculatorServiceServer interface {
	...
	PrimeFactors(*PrimeRequest, CalculatorService_PrimeFactorsServer) error
...
func (UnimplementedCalculatorServiceServer) PrimeFactors(*PrimeRequest, CalculatorService_PrimeFactorsServer) error {
...
func _CalculatorService_Sum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/numbers.CalculatorService/Sum",
	}
...
func (x *calculatorServicePrimeFactorsServer) Send(m *PrimeResponse) error {
...
var CalculatorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "numbers.CalculatorService",
